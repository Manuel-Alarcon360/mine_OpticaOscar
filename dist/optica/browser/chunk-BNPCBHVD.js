import{Fa as A,Ia as P,j as Q,l as E,n as N,p as O,ya as q,za as g}from"./chunk-RKU7U7Z5.js";import{$ as p,Bb as l,Cb as D,Db as F,Gb as f,Ib as m,Jb as y,Ka as o,L as v,M as h,Nb as j,Ob as S,R as T,Vb as z,Wa as b,Xa as C,_a as $,ab as r,ib as i,lb as k,mb as I,oc as B,sb as u,tb as d,ub as x,vb as M,wb as w}from"./chunk-3POYB5FS.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
